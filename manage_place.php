...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['delete_place_id'])) {
    $place_id = $_POST['delete_place_id'];
    $delete_query = "DELETE FROM places WHERE place_id = ?";
...
<head>
    ...
    <title>MANAGE PLACES | Motor Vloggers Assist</title>
            ...
            <div class="col-md-6 mb-4">
                <div class="card bg-dark text-white">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" class="mt-3 d-flex" onsubmit="return confirmDeletion();">
                            <input type="hidden" name="delete_place_id" value="<?php echo $place['place_id']; ?>">
                            <a href='edit_place.php?place_id=<?= $place['place_id'] ?>'>
                                <button type='button' class='btn bg-white btn-lg btn-block' style="margin-right:10px">Edit</button>
                            </a>
                            <a href='delete_place.php?place_id=<?= $place['place_id'] ?>' onclick="return confirm('Are you sure you want to delete this place?');">
