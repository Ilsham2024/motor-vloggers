...
<form method = "POST">
    ...
    <div class="d-grid gap-2 col-6 mx-auto">
                <button class="btn btn-dark btn-lg my-2" type ="submit" name="place">Place Suggestion</button>
                <button class="btn btn-dark btn-lg my-2" type ="submit" name="event">Events</button>
                <button class="btn btn-dark btn-lg my-2" type ="submit" name="mechanics">Nearby Mechanics</button>
                <button class="btn btn-dark btn-lg my-2" type ="submit" name="ride">Start Ride</button>
    </div>
</form>
